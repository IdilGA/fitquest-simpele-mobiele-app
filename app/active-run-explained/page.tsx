...
import { RunExplanation } from "@/components/run-explanation"

export default function ActiveRunExplainedPage() {
  ...
  return (
    <div className="container max-w-md mx-auto px-4 py-8">
      ...
      {showExplanation && <RunExplanation onClose={() => setShowExplanation(false)} />}
          ...
          <Card className="mb-4 relative">
            <CardContent className="p-0 overflow-hidden rounded-lg">
              ...
              <div className="absolute top-2 left-2 bg-white/80 backdrop-blur-sm px-2 py-1 rounded text-xs font-medium">
                Live locaties van jou en je buddy
              </div>
            </CardContent>
          </Card>
        )}
